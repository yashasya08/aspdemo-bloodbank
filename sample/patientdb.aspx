<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="patientdb.aspx.cs" Inherits="Default3" %>
...
<br />
    ...
    <br />
<h1 class="style5"><strong>Total Patient List </strong> </h1>
    <p class="style5">&nbsp;</p>
</div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [patient] ORDER BY [Name]"></asp:SqlDataSource>
    <br />
</asp:Content>
